...
/**
 * Player-independent embedded subtitle timeline loader (desktop/JVM, Matroska/WebM only).
 *
 ...
 * AutoSync simply does not run for that file (no MP4 fallback, no live-playback fallback on desktop).
 *
